...
import br.com.techne.couse.entities.enums.OrderStatus;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Order o2 = new Order(null, Instant.parse("2019-07-21T03:42:12Z"),OrderStatus.WAITING_PAYMENT, u2);
		Order o3 = new Order(null, Instant.parse("2019-07-21T05:32:32Z"),OrderStatus.WAITING_PAYMENT, u2);
